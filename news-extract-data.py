...
for i in containers:
    title = i.find_element(By.CLASS_NAME, 'teaser__headline').text
    subtitle = i.find_element(By.CLASS_NAME, 'teaser__subdeck').text
    link = i.find_element(By.CLASS_NAME, 'text-anchor-wrap').get_attribute("href")
